...
class PerformanceDynamic_taobao_0020(testsuite):
    ...
    def case_step_3(self):
        ...
        # if dingwei is None:
        #     dingwei = (259, 457)
        self.d.touch((211, 395), wait_time=2)
    ...
    def case_step_4(self):
        ...
        # else:
        self.d.touch((985, 175), wait_time=2)#输入蜜雪冰城后，点击搜索
    ...
    def case_step_5(self):
        ...
        self.d.touch((685, 579), wait_time=2)#点击第一家蜜雪冰城
        swipes_down(self.d, 3,2)#滑到最上面
        self.d.touch((610, 186), wait_time=2)#点击搜索标志
        ...
        self.d.touch((527, 329), wait_time=2)  # 点击冰鲜柠檬水
        self.d.touch((884, 1329), wait_time=2) #点击加入购物车
